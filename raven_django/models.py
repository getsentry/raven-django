...
def get_client(client=None):
    ...
    if not tmp_client:
        client = getattr(django_settings, 'SENTRY_CLIENT', 'raven_django.DjangoClient')
    ...
    if _client[0] != client:
        ...
        try:
            ...
            if not _client[1]:
                ...
                client = 'raven_django.DjangoClient'
...
def register_serializers():
    ...
    import raven_django.serializers  # NOQA

if ('raven_django' in django_settings.INSTALLED_APPS
        or 'raven.contrib.django' in django_settings.INSTALLED_APPS
